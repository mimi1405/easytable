...
export const orderSnapshots = pgTable("order_snapshots", {
  ...
  tableContextJson: jsonb("table_context_json"),
  ...
  uniqueIndex("idx_order_snapshots_local").on(table.tenantId, table.locationId, table.localMasterInstanceId, table.id),
  uniqueIndex("idx_order_snapshots_local_order").on(table.tenantId, table.locationId, table.localMasterInstanceId, table.orderId),
  index("idx_order_snapshots_reporting").on(table.tenantId, table.locationId, table.businessDate, table.localCreatedAt),
  index("idx_order_snapshots_payment").on(table.tenantId, table.locationId, table.paymentMethod, table.paymentId),
  index("idx_order_snapshots_terminal").on(table.tenantId, table.locationId, table.terminalId),
]);

export const orderSnapshotLines = pgTable("order_snapshot_lines", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull().references(() => tenants.id, { onDelete: "cascade" }),
  locationId: text("location_id").notNull(),
  localMasterInstanceId: text("local_master_instance_id").notNull(),
  ...
  uniqueIndex("idx_order_snapshot_lines_local").on(table.tenantId, table.locationId, table.localMasterInstanceId, table.snapshotId, table.lineId),
  index("idx_order_snapshot_lines_order").on(table.tenantId, table.locationId, table.orderId),
  index("idx_order_snapshot_lines_product").on(table.tenantId, table.locationId, table.productId, table.productName),
]);

export const salesLedgerEntries = pgTable("sales_ledger_entries", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull().references(() => tenants.id, { onDelete: "cascade" }),
  locationId: text("location_id").notNull(),
  localMasterInstanceId: text("local_master_instance_id").notNull(),
  ...
  uniqueIndex("idx_sales_ledger_local").on(table.tenantId, table.locationId, table.localMasterInstanceId, table.id),
  index("idx_sales_ledger_reporting").on(table.tenantId, table.locationId, table.businessDate, table.occurredAt),
  index("idx_sales_ledger_order").on(table.tenantId, table.locationId, table.orderId, table.entryType),
  index("idx_sales_ledger_method").on(table.tenantId, table.locationId, table.paymentMethod, table.businessDate),
  index("idx_sales_ledger_terminal").on(table.tenantId, table.locationId, table.terminalId, table.businessDate),
]);

export const localMasterOutboxEvents = pgTable("local_master_outbox_events", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull().references(() => tenants.id, { onDelete: "cascade" }),
  locationId: text("location_id").notNull(),
  localMasterInstanceId: text("local_master_instance_id").notNull(),
  ...
  uniqueIndex("idx_local_master_outbox_events_local").on(table.tenantId, table.locationId, table.localMasterInstanceId, table.id),
  index("idx_local_master_outbox_events_reporting").on(table.tenantId, table.locationId, table.localCreatedAt),
  index("idx_local_master_outbox_events_aggregate").on(table.tenantId, table.locationId, table.aggregateId),
]);
